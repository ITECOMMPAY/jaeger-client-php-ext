...
uint32_t Agent_emitZipkinBatch_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("spans", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    std::vector< ::Span> ::const_iterator _iter5;
...
void AgentConcurrentClient::emitZipkinBatch(const std::vector< ::Span> & spans)
{
  send_emitZipkinBatch(spans);
}

void AgentConcurrentClient::send_emitZipkinBatch(const std::vector< ::Span> & spans)
{
  int32_t cseqid = 0;
...
void AgentConcurrentClient::emitBatch(const  ::Batch& batch)
{
  send_emitBatch(batch);
}

void AgentConcurrentClient::send_emitBatch(const  ::Batch& batch)
{
  int32_t cseqid = 0;
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("emitBatch", ::apache::thrift::protocol::T_ONEWAY, cseqid);
